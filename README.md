...
- **"Next targeted rebirth" panel** (1–30, across the 4 super-rebirth cycles): the 3 required droids with their status (✗ not owned, ⚠ owned but not in base, ✓ ready), the credits needed and the slot unlocked.
...
The data (69 tracked droids including 7 Iconics, rebirth requirements for the 4 cycles × 30 levels, credit costs, per-variant income, Beskar costs and perks) is maintained in [`site/data.js`](site/data.js) from community sources, cross-checked on 2026-07-28:
