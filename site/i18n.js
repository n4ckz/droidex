...
const I18N = {
  en: {
    ...
    syncNewerLoaded: 'Newer account backup loaded ({0}) — the previous registry of this device is kept as a local safety copy',
    syncNewerSent: 'This device was more recent ({0}) — account backup updated',
  ...
  fr: {
    ...
    syncNewerLoaded: 'Sauvegarde du compte plus récente chargée ({0}) — l\'ancien registre de cet appareil est gardé en copie de secours locale',
    syncNewerSent: 'Cet appareil était plus récent ({0}) — sauvegarde du compte mise à jour',
