...
const I18N = {
  en: {
    ...
    rbShort: 'RB',
    unlocks: 'Unlock: {0}',
    collectionBonus: '{0}/{1} distinct · bonus +{2}%',
    flawlessCount: '✦ {0}/{1} (×{2})',
    liveCcu: '● {0} in game',
    filterWish: 'Wish ★',
    sortRarity: 'Rarity',
    ...
    wishAria: 'Wishlist',
    flawAria: 'Flawless',
    fusionHint: 'Fusion-only droid — fuse these three droids at the Fusion lab (result keeps the lowest variant used)',
    ...
    syncNewerLoaded: 'Registry updated',
  ...
  fr: {
    ...
    rbShort: 'RB',
    unlocks: 'Débloque : {0}',
    collectionBonus: '{0}/{1} distincts · bonus +{2}%',
    flawlessCount: '✦ {0}/{1} (×{2})',
    liveCcu: '● {0} en jeu',
    filterWish: 'Wish ★',
    sortRarity: 'Rareté',
    ...
    flawAria: 'Flawless',
    fusionHint: 'Droïde obtenable uniquement par fusion — fusionne ces trois droïdes au labo de fusion (le résultat garde la variante la plus basse utilisée)',
    ...
    syncNewerLoaded: 'Registre mis à jour',
